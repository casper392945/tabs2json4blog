...
function fetchData(inputValue) {
  ...
  fetch("assets/data/tabs2json4blog.json", {
    ...
    .then((data) => {
      ...
      const uniqueCount = Object.keys(uniqueHostnames).length;
      console.log('Total unique hostnames:', uniqueCount);
      sorted = (Object.keys(uniqueHostnames)).sort();
      console.log(sorted);
      ...
      const uniqueCount = Object.keys(uniqueOgType).length;
      console.log('Total unique og:type:', uniqueCount);
