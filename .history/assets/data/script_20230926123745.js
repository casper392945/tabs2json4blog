...
function fetchData() {
  fetch("assets/data/tabs2json4blog.json")
    ...
    .then((data) => {
      const filteredData = ata.filter((item) => {
        // Replace "og:description" with the appropriate property key
        // Replace searchValue with the search value obtained from the search function
